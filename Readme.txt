...
1. Step 1: Prepare the required files to conduct MSA using your model. The required files are:
	* Canti2DEQ.py 
		...
		# return a list of: 
			1. nodes (cntrl_nodes) at which the displacement and acceleration time histories are supposed to be recorded.
			2. Fundamental period of the building (T1)
			3. List of heights of each storey starting from the bottom 
	* IDA_parallel.py
...
Details about IDA_leader_follower.py: 
...
Step 2: RUN PARALLEL IDA USING OPENSEESPY
